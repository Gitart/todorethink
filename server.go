...
func indexHandler(w http.ResponseWriter, req *http.Request) {
	...
	renderTemplate(w, "index", map[string]interface{}{"Items": items,"Route": "all"})
}
...
func activeIndexHandler(w http.ResponseWriter, req *http.Request) {
	...
	renderTemplate(w, "index", map[string]interface{}{"Items": items,"Route": "active"})
}
...
func completedIndexHandler(w http.ResponseWriter, req *http.Request) {
	...
	renderTemplate(w, "index", map[string]interface{}{"Items": items,"Route": "completed"})
}
...
func toggleHandler(w http.ResponseWriter, req *http.Request) {
	...
	// Toggle the item
	_, err = r.Table("items").Get(id).Update(map[string]interface{}{"Status": r.Branch(r.Row.Field("Status").Eq("active"),"complete","active")}).RunWrite(session)
